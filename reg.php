...
body{
       ...
       background-image:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('./image/new.jpg');
       height:100vh;
...
<br>
<!--Registration Table-->
<table border="1" bgcolor="white" width="40%" align="center" height="8%">
<tr>
<td>
    <br>
<center>
<fieldset style="width:300px;font-size:30px" >
<legend>Registration Form</legend>
<form name="form" form action="" method="post" oninput="txtr.value=parseInt(txtf.value)-parseInt(txtp.value)" enctype="multipart/form-data">
...
<tr><td></td><td><input type="submit" value="Save" id="button" name="btn"/></td>
</tr>
</table>
</form>
</fieldset>
